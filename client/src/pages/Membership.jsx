...
export default function Membership({user ,x }) {
      ...
      <Card>
        <Card.Body>
          <div style={{ marginLeft: "10px" }}>
            <p style={{ fontWeight: "600", fontSize: "20px" }}>{user.Plan}</p>
            ...
            <Row>
              <Col>
                ...
                >
                   <Link style={{textDecoration:"none",color:"black"}} to="/cplan" state={{user:user , x:x}}> Change Plan</Link>
                </p>
              </Col>
              <Col>
                <svg
        ...
        <Card>
          <Card.Body>
            <div>
              ...
              >
                {user.date[0].date}-{user.date[0].month}-{user.date[0].year}
              </p>
              <p
                style={{
                  marginLeft: "15px",
              ...
              <hr></hr>
              <Link style={{textDecoration:"none",color:"black"}} to="/managepayment" state={{user:user , x:x}}>
              <Row>
                <Col>
                  <p
                    style={{
